...
if (isset($_POST['send_mail'])) {
	...
	$mail->setFrom('ashish32623@gmail.com', 'ash');
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="contact-form">
                    <h1>Get in Touch</h1>
                    <form action="send_mail_using_phpmailer.php" method="post">
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary" name="send_mail"><i class="fa fa-paper-plane"></i> Send</button>
                        </div>
                    </form>
                </div>
            </div>
