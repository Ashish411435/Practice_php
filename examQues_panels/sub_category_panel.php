...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "SELECT * FROM `sub_category` WHERE name = '$subCategoryName' && cat_id = '$categoryId'";
        ...
        if ($row_count > 0) {
            ...
            $sql = "INSERT INTO `sub_category` (name, cat_id) VALUES ('$subCategoryName', '$categoryId')";
            $result = mysqli_query($con, $sql);
            if ($result) {
                            ...
                            <div class="card-body p-5">
                                ...
                                <form action="sub_category_panel.php" onsubmit="return formSubmit()" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" id="subCategory" name="subCategoryName" class="form-control" placeholder="Enter sub-category name" required />
                                    </div>
