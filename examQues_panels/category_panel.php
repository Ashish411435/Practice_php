...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "SELECT * FROM `exam_category` WHERE name = '$category'";
        ...
        if($row_count > 0)
        {
            ...
            $sql = "INSERT INTO `exam_category` (name) VALUES ('$category');";
            $result = mysqli_query($con, $sql);
                            ...
                            <div class="card-body p-5">
                                ...
                                <form action="category_panel.php" onsubmit="return formSubmit()" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="myName">Category : </label>
                                        <input type="text" id="myCategory" class="form-control form-control-lg" placeholder="Enter Category" id="myCategory" name="category" required />
                                    </div>
